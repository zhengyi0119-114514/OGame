...
OgException OgStringCopy(OgConstString pcsSource,
    ...
    OgUnsignedIntegerSize uDestinationSize)
{
    ...
    {
        return OgExceptionThrowOutOfRange("uDestinationSize");
    }
...
OgException OgStringConcatenation(OgString psDestination,
    OgUnsignedIntegerSize uDestinationSize,
