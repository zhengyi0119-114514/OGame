...
set(OPEN_STG_COPY_TO_BINARY_DIRECTORY TRUE)
cmake_path(APPEND CMAKE_BINARY_DIR "binary" OUTPUT_VARIABLE OPEN_STG_COPY_BINARY_DIR)

if(NOT EXISTS "${OPEN_STG_COPY_TO_BINARY_DIRECTORY}")
    file(MAKE_DIRECTORY "${OPEN_STG_COPY_TO_BINARY_DIRECTORY}")
endif()


set(RUST_BINARY_DIR "${OPEN_STG_COPY_BINARY_DIR}")
set(ADD_TARGET_BINARY_DIR "${OPEN_STG_COPY_BINARY_DIR}")