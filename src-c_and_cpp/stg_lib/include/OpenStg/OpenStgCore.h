 ...
 * @return OG_EXTERN 
 */
OG_EXTERN BOOL_T OG_API OgCrQuit();
/**
...
OG_EXTERN BOOL_T OG_API OgCrInitProgramModule();
/**
 * @brief 注销指定名称的模块
 ...
 * @return OG_EXTERN
 */
OG_EXTERN BOOL_T OG_API OgCrUnregisterProgramModule(PROGRAM_MODULE_HANDLE pModule);
 ...
 */
OG_EXTERN PROGRAM_MODULE_HANDLE OG_API OgCrGetProgramModulePointerByNamespace(OG_MODULE_NAMESPACE_T uNamespace);
/**
 * @brief 通过模块注册名获取模块指针
 *
 ...
 * @return PTR_PROGRAM_MODULE 目标模块指针
 */
OG_EXTERN PROGRAM_MODULE_HANDLE OG_API OgCrGetProgramModulePointerByRegistrerdName(const char* pszRegisteredName);
/**
 ...
 */
OG_EXTERN void * OG_API OgCrGetProgramModuleAdditionalData(PROGRAM_MODULE_HANDLE pModule);
