...
extern "C"
{
    ...
    OG_EXPORT BOOL_T OG_API OgCrUnregisterProgramModule(PROGRAM_MODULE_HANDLE pModule);
    ...
    OG_EXPORT PROGRAM_MODULE_HANDLE OG_API OgCrGetProgramModulePointerByRegistrerdName(const char *pszRegisteredName);
    OG_EXPORT void *OG_API OgCrGetProgramModuleAdditionalData(PROGRAM_MODULE_HANDLE pModule);
...
#define OG_CHAR_BUFFER OgCrGetCharBuffer()
    ...
    OG_INTERNAL BOOL_T OG_API ogCrDestroyModuleRegistrar(void);
    OG_EXPORT PROGRAM_MODULE_HANDLE OG_API OgCrGetProgramModulePointerByNamespace(OG_MODULE_NAMESPACE_T uNamespace);
    OG_INTERNAL OG_CR_UNIVERSAL_REGISTRAR *OG_API ogCrPvCreateProgramStaticVariableContainer();
    OG_EXPORT BOOL_T OG_API OgCrInit();
    OG_EXPORT BOOL_T OG_API OgCrQuit();
