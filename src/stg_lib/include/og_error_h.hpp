...
class FunctionsNotRealizedException : std::exception
{
  private:
  ...
  public:
    /**
     * @brief Construct a new Functions Not Realized Exception object[构造FunctionsNotRealizedException对象]
     *
     * @param sFunction
     */
    explicit FunctionsNotRealizedException(std::string_view svFunction);
    /**
     * @brief Get error message[获取错误信息]
     * @return const char* Error message[错误信息]
     */
...
class SDLException : std::exception
{
  ...
  public:
    /**
     * @brief Construct a new SDLException object
     * @param svFunction
     */
    explicit SDLException(std::string_view svFunction);
    /**
     * @brief Get error message[获取错误信息]
     * @return const char* Error message[错误信息]
     */
